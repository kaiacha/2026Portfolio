...
interface RoleSelectorProps {
  selectedRole?: 'navigator' | 'pilot' | 'ems'
  onRoleSelect: (role: 'navigator' | 'pilot' | 'ems') => void
}

function RoleSelector({ selectedRole = 'navigator', onRoleSelect }: RoleSelectorProps) {
  ...
  return (
    <div className={styles.roleSelector}>
      ...
      {isAlertVisible && (
        <div className={`${alertStyles.alertBanner} ${isClosing ? alertStyles.alertBannerClosing : ''}`}>
          ...
          <button className={alertStyles.closeButton} onClick={handleCloseAlert} aria-label="Close alert">
