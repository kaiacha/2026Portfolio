...
function MainPanel({ selectedRoute, latitude, longitude }: MainPanelProps) {
      ...
      <div className={styles.navigationSection}>
        <div className={styles.navigationHeader}>
          ...
          <div className={styles.coordinatesBadge}>
            ...
            <span className={styles.coordinatesText}>37.7849° N, 122.4094° W</span>
          </div>
        </div>
          ...
          <div className={styles.mapElements}>
            ...
            <div
              className={`${styles.routeMarker1} ${
                selectedRoute === 'fastest' ? styles.routeMarkerActive : styles.routeMarkerInactive
              }`}
            >
              1
            </div>
            <div
              className={`${styles.routeMarker2} ${
                selectedRoute === 'safest' ? styles.routeMarkerActive : styles.routeMarkerInactive
              }`}
            >
              2
            </div>
