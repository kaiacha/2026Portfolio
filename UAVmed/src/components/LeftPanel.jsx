...
function LeftPanel({ latitude, longitude }) {
  // ETA State
        ...
        <div className={styles.etaHeader}>
          ...
          <div className={styles.etaInfo}>
            ...
            <div className={styles.etaTime}>
              {formatTime(etaTime.hours, etaTime.minutes, etaTime.seconds)}
            </div>
          </div>
        ...
        <div className={styles.metricCard}>
          ...
          <div className={styles.progressBar}>
            <div
              ...
              style={{ width: `${(groundSpeed / maxSpeed) * 100}%` }}
            ></div>
          </div>
          <div className={styles.progressLabels}>
            <span>0 mph</span>
      ...
      <div className={styles.radarCard}>
        ...
        <div className={styles.radarDisplay}>
          <div className={styles.radarCircle}>
            ...
            {/* Detection dots */}
            <div
              className={styles.radarDotWarning}
              style={{ top: "25%", left: "70%" }}
            ></div>
            <div
              className={styles.radarDotDanger}
              style={{ top: "60%", left: "20%" }}
            ></div>
            <div
              className={styles.radarDotInfo}
