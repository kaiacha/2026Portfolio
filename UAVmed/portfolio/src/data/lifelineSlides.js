...
// Image imports - Update these paths to match your Next.js public folder structure
// In Next.js, images should be in: public/images/lifeline/
import emergencyImage from "../images/emergency.png";
import wireframeNavigator from "../images/(updated) Wireframe - Navigator.png";
import wireframePilot from "../images/(updated) Wireframe - pilot.png";
import wireframeEMS from "../images/(updated) Wireframe - EMS.png";
import emsControllerImage from "../images/Pilot Controller.png";
import pilotControllerImage from "../images/controller.png";
import navigatorControllerImage from "../images/doublemonitor.png";
import workspaceImage1 from "../images/2.png";
import workspaceImage2 from "../images/3.png";
import workspaceImage3 from "../images/5.png";
import workspaceImage4 from "../images/chair_annotation.png";
import beforeAlertImage from "../images/before-alart.png";
import afterAlertImage from "../images/after-alart.png";
import beforeLiveCameraImage from "../images/before-livecamera.png";
import afterLiveCameraImage from "../images/after-livecamera.png";

// Dashboard components - Imported in App.jsx and added dynamically
// Note: For Next.js, uncomment these and import them here
...
export const lifelineSlides = [
  {
    ...
    // component: NavigatorDashboard, // Added dynamically in App.jsx
  },
  {
    id: "overview",
  ...
  },
  {
    ...
    `,
    layout: "split",
    images: [wireframeNavigator, wireframePilot, wireframeEMS],
    imageAlts: [
      "Navigator Dashboard Wireframe",
      "Pilot Dashboard Wireframe",
      "EMS Dashboard Wireframe",
    ],
  },
  {
  ...
  },
  {
    ...
    `,
    // component: PilotDashboard, // Added dynamically in App.jsx
  },
  {
    id: "dashboard-ems",
    tag: "05. Dashboard Design",
    ...
    `,
    // component: EMSDashboard, // Added dynamically in App.jsx
  },
  {
    ...
    `,
    image: pilotControllerImage,
    imageAlt:
      "Pilot Controller Design - Rugged drone controller with joysticks and display",
  },
  {
    ...
    `,
    image: navigatorControllerImage,
    imageAlt:
      "Navigator Controller Design - Dual monitor workstation with dashboard interface",
  },
  {
    id: "controllers-ems",
    tag: "06. Physical Controller Design",
    ...
    `,
    image: emsControllerImage,
    imageAlt:
      "EMS Controller Design - Rugged laptop with dashboard interface",
  },
  {
    id: "workspace",
  ...
  },
  {
    ...
    layout: "split",
    beforeAfterImages: {
      before: beforeAlertImage,
      after: afterAlertImage,
  ...
  },
  {
    ...
    layout: "split",
    beforeAfterImages: {
      before: beforeLiveCameraImage,
      after: afterLiveCameraImage,
